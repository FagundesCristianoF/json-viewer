...
#ifndef JSON_VIEWER_SWIFT_H
#define JSON_VIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Json_Viewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC11Json_Viewer20CommandResponderView")
@interface CommandResponderView : NSView
@property (nonatomic, readonly) BOOL acceptsFirstResponder;
- (void)openWorkspace:(id _Nullable)sender;
...
@class NSEvent;
@class NSScrollView;
SWIFT_CLASS("_TtC11Json_Viewer19LineNumberRulerView")
